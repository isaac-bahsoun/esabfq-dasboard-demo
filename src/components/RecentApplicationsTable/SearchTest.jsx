...
import { CheckboxWrapper, ResetButton, SearchInput, SelectHeader, StyledCheckbox, TableWrapper } from "./RecentApplicationsTableStyles.js";
          ...
          <tr key={app.application_id}>
            {selectedColumns.map((colName) => (
              <td key={`${app.application_id}-${colName}`}>
                {colName === 'created_at' || colName === 'date_of_birth'
                  ? new Date(app[colName]).toLocaleDateString('en-GB')
                  : app[colName]}
              </td>
            ))}
          </tr>
