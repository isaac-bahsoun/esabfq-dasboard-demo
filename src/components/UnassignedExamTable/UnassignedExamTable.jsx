...
import { SearchInput, TableWrapper } from "./UnassignedExamTableStyle.js";
import LoadingScreen from "../../elements/Loading.jsx";
import { getAllCandidatesUnassignedExam } from "../../apiCalls/candidate.js";


export default function UnassignedExamTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getAllCandidatesUnassignedExam();
        setCandidates(data);
