...
import { createTraining } from '../../apiCalls/training.js';
import { getAllInstructors } from '../../apiCalls/user.js';
import Modal from '../MessageModal/modal.jsx';
import { DivContainer, DivDate, DivTime, DivTimeEnd, InputD, InputT, LabelT, OptionT, Shape, StyleButton, WrapperDiv } from './CreateTrainingFormStyle.js';
...
// ]
    ...
    const handleSubmit = async () =>{
        ...
        {
            const title = `T-${qualificationAbv}-${date}-${startTime}-${endTime}-${roomName}`;
            const payload = {
              type: "training",
